...
\begin{abstract}
This is the abstract. Please write some more text here, I feel small and empty inside.
\end{abstract}
...
WordNet is an electronic lexical database \citep{kilgarriff2000wordnet}. % TODO: Add some more information on WordNet.
