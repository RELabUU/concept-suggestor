...
\begin{algorithmic}[1]
	\Procedure{OneTwoCompoundPipeline}{wordA, word1B, word2B}
		\State $\textit{simA} \gets \textit{TwoWordPipeline}(wordA, word2B)$
		\State $\textit{simB} \gets \textit{TwoWordPipeline}(wordA, word1B)$
...
\begin{algorithmic}[1]
	\Procedure{TwoCompoundPipeline}{word1A, word2A, word1B, word2B}
		\State $\textit{simA} \gets \textit{TwoWordPipeline}(word2A, word2B)$
		\State $\textit{simB} \gets \textit{TwoWordPipeline}(word1A, word1B)$
		\State $\textit{simC1} \gets \textit{TwoWordPipeline}(word1A, word2B)$
		\State $\textit{simC2} \gets \textit{TwoWordPipeline}(word2A, word1B)$
