...
NLTK offers six methods to calculate the similarity of two words \citep{pedersen2004wordnet}. These six methods are further explained and compared to each other below.
\begin{itemize}
